    ...
    <div className='flex flex-col md:flex-row flex-wrap  bg-primary px-6 md:px-10 lg:px-20 rounded-lg'>
       ...
       <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-7.5'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-3 text-white text-sm font-light'>
            ...
            <p>Simply browse through our extensive list of  doctors, <br className='hidden sm:block' />  schedule your appointments with ease.</p>
        </div>
        <a className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300' href="#speciality">
