    ...
    <div className='flex flex-col gap-4 items-center my-16 text-gray-900 md:mx-10'>
        ...
        <div className='w-full grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0'>
            {relDoc.slice(0,5).map((item, index) => (
                <div onClick={() => {navigate(`/appointments/${item._id}`) ; scrollTo(0,0)}} className='border border-blue-200 overflow-hidden rounded-xl cursor-pointer hover:translate-y-2.5 transition-all duration-500' key={index}>
